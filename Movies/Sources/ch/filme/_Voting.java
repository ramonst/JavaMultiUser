...
public abstract class _Voting extends  ERXGenericRecord {
  ...
  // Attribute Keys
  public static final ERXKey<Long> NUMBER_OF_VOTES = new ERXKey<Long>("numberOfVotes");
  ...
  public Long numberOfVotes() {
    return (Long) storedValueForKey(_Voting.NUMBER_OF_VOTES_KEY);
  }

  public void setNumberOfVotes(Long value) {
  ...
  public ch.filme.Movie movie() {
    return (ch.filme.Movie)storedValueForKey(_Voting.MOVIE_KEY);
  }
